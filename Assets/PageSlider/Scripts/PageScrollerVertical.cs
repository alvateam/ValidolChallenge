...
namespace TS.PageSlider
{
    ...
    /// </summary>
    public class PageScrollerVertical : MonoBehaviour, IBeginDragHandler, IEndDragHandler
    {
        #region Variables
        ...
        {
            var contentWidth = _scrollRect.content.rect.height;
            var rectWidth = ((RectTransform)_scrollRect.transform).rect.size.y;
